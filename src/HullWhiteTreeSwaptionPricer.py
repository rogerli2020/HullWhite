...
class HullWhiteTreeEuropeanSwaptionPricer:
    ...
    @staticmethod
    def _price(swaption: EuropeanSwaption, tree: VectorizedHW1FTrinomialTree) -> float:
        # query wise information
        expiry_layer_row_index: int
        expiry_layer_mask: np.ndarray
        expiry_layer_t: float
